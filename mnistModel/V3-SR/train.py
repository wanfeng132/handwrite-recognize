...
class Train:
    ...
    def train(self):
        ...
        file_write = tf.summary.FileWriter('/home/liuyan/Desktop/untitled2/mnistModel/TensorBoard_log', graph=self.sess.graph)
        ...
        for i in range(train_step):
            ...
            if (i + 1) % 100 == 0:
                file_write.add_summary(merged_summary, i+1)
                print('第%5d步，当前loss：%.2f' % (i + 1, loss))
        saver.save(self.sess, CKPT_DIR+'/model')
